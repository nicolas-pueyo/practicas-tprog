...
int main(int argc, char** argv)
{
	...
	contenedor_estandar->guardar(longaniza_graus); //comment de yago:
	//el problema aqui es que estoy haciendo un contenedor (y por ende filtro y por ende almacen)
	// que contiene cargas. No deja poner punteros a productos como cargas, aunque los productos heredan de carga, por
	// lo que no termino de entender el problema
